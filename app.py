...
st.markdown("<h1 style='position: absolute; top: 35px; left: 10px; color: #4CAF50; font-size: 40px; z-index: 100; font-weight: 800; display: flex; align-items: center;'>FINANCIAL CENTER</h1>", unsafe_allow_html=True)
